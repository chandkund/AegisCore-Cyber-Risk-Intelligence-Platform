...
Usage (from repository root):
  ...
  set DATABASE_URL=postgresql+psycopg://user:pass@localhost:5432/aegiscore

  python scripts/seed_oltp.py



Optional: AEGISCORE_SEED_PASSWORD overrides default demo password (see database/seeds/manifest.json).
...
def main() -> None:
    ...
    demo_pw = os.environ.get(
        ...
        manifest.get("demo_password_env", "AEGISCORE_SEED_PASSWORD"),

        manifest.get("default_demo_password", "AegisCore!demo2026"),
        ...
        for r in users:
            ...
            conn.execute(
                ...
                text(
                    ...
                    VALUES (:id, :tenant_id, :email, :hp, :fn, true)
            ...
            conn.execute(
                ...
                text(
                    ...
                    INSERT INTO assets (
                        ...
                        id, tenant_id, name, asset_type, hostname, ip_address,
                    ...
                    VALUES (
                        ...
                        :id, :tenant_id, :name, :atype, :host, :ip,
            ...
            conn.execute(
                ...
                text(
                    ...
                    INSERT INTO vulnerability_findings (
                        ...
                        id, tenant_id, asset_id, cve_record_id, status, discovered_at,
                    ...
                    VALUES (
                        ...
                        :id, :tenant_id, :aid, :cve, :status, :disc,
