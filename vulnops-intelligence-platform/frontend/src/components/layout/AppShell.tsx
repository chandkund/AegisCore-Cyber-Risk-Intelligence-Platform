...
const nav = [
  ...
  { href: "/prioritized", label: "Prioritized" },
    ...
    <Link
      ...
      className={cn(
        ...
        active
          ...
          : "text-slate-400 hover:bg-surface-muted hover:text-app-fg"
    ...
    <div className="flex min-h-screen flex-col md:flex-row">
      ...
      <header className="border-b border-slate-800 bg-slate-950/95 md:hidden">
        ...
        <div className="flex items-center justify-between px-4 py-3">
          ...
          <span className="font-semibold text-slate-100">AegisCore</span>
      ...
      <aside
        ...
        className="hidden w-56 shrink-0 border-r border-app-border bg-surface/70 md:block"
      ...
      >
        ...
        <div className="flex h-full flex-col p-4">
          ...
          <div className="mb-6 text-lg font-bold tracking-tight text-accent">
          ...
          <div className="mt-6 border-t border-app-border pt-4 text-xs text-slate-500">

            <p className="truncate font-medium text-app-fg">{user?.full_name}</p>
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <header className="hidden border-b border-app-border bg-surface/70 px-6 py-4 md:block">

          <div className="flex items-center justify-between gap-4">

            <h1 className="text-xl font-semibold text-app-fg">Intelligence</h1>
